        ...
        private int CalculatePlayerDamageDone()
        {
            ...
            switch (_player.PlayerSelectedWeapon)
            {
                case Enums.PlayerSelectedWeapon.Sword:
                    weaponDamageFactor = _enemy.SwordResistance - (1 - (RESISTANCE_DECREASE_DEPENDING_ON_SKILL * _player.SwordSkillLevel));
                    break;
                case Enums.PlayerSelectedWeapon.Bow:
                    weaponDamageFactor = _enemy.ArrowResistance * (1 - (RESISTANCE_DECREASE_DEPENDING_ON_SKILL * _player.BowSkillLevel));
                    break;
                case Enums.PlayerSelectedWeapon.Halberd:
                    weaponDamageFactor = _enemy.HalberdResistance - (1 - (RESISTANCE_DECREASE_DEPENDING_ON_SKILL * _player.HalberdSkillLevel));
                    break;
                default: break;
            }
